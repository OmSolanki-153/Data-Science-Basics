...
sInputFileName='C:/MScITPracs/MU-DATA-SCIENCE/2ch-sound.wav'
print('=====================================================')
...
sOutputFileName='C:/MScITPracs/MU-DATA-SCIENCE/HORUS-Audio-2ch.csv'
OutputData.to_csv(sOutputFileName, index = False)

sInputFileName='C:/MScITPracs/MU-DATA-SCIENCE/4ch-sound.wav'
print('=====================================================')
print('Processing : ', sInputFileName)
print('=====================================================')
InputRate, InputData = wavfile.read(sInputFileName)
...
ProcessData.columns=sColumns
OutputData=ProcessData
sOutputFileName='C:/MScITPracs/MU-DATA-SCIENCE/HORUS-Audio-4ch.csv'
OutputData.to_csv(sOutputFileName, index = False)

sInputFileName='C:/MScITPracs/MU-DATA-SCIENCE/6ch-sound.wav'
print('=====================================================')
print('Processing : ', sInputFileName)
print('=====================================================')
InputRate, InputData = wavfile.read(sInputFileName)
...
ProcessData.columns=sColumns
OutputData=ProcessData
sOutputFileName='C:/MScITPracs/MU-DATA-SCIENCE/HORUS-Audio-6ch.csv'
OutputData.to_csv(sOutputFileName, index = False)

sInputFileName='C:/MScITPracs/MU-DATA-SCIENCE/8ch-sound.wav'
print('=====================================================')
print('Processing : ', sInputFileName)
print('=====================================================')
InputRate, InputData = wavfile.read(sInputFileName)
...
ProcessData.columns=sColumns
OutputData=ProcessData
sOutputFileName='C:/MScITPracs/MU-DATA-SCIENCE/HORUS-Audio-8ch.csv'
OutputData.to_csv(sOutputFileName, index = False)
print('=====================================================')
